...
import { CreateWorkProjectSchema, type CreateWorkProjectInput } from '@/lib/validations/master-resume';
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-lg max-h-[85vh] overflow-y-auto">
				...
				{open && <WorkProjectDialogForm key={project?.id ?? 'new'} roleId={roleId} project={project} onOpenChange={onOpenChange} />}
			</DialogContent>
		</Dialog>
	);
}
